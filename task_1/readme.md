...
Увеличьте значение newValue на 1
Увеличьте значение newValue на 1Увеличьте значение newValue на 1Увеличьте значение newValue на 1
...
2. Если обнаружены какие-то ошибки - исправьте их и проверьте решение снова - не расстраивайтесь!// comment
3. Отправьте изменения в удаленный репозиторий
4. Отправьте преподавателю на проверку ссылку на github и ссылку на github-pages // comment
