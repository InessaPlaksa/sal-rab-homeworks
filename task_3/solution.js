function renderCartItem(item) {
 ...
 // например, {id: 1, title: 'Пицца', count: 5, price: '500.00'}, где
    ...
    // например,
    // 5 × 500.00 ₽ = 2500 ₽
    let itemCountText = null // 1. Создайте переменную itemCountText, равную пустой строке
    ...
    temCountText = itemCountText + sum; // 7. Присвойте переменной itemCountText результат склеивания itemCountText и sum
