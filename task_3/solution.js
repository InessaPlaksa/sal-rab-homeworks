function renderCartItem(item) {
    ...
    let pizza {id: 1, title: 'Пицца', count: 1, price: '500.00'};// product - объект вида {id: id, title: title, count: count, price: price}
    let cheburek {id: 2, title: 'Чебурек', count: 1, price: '120.00'};// например, {id: 1, title: 'Пицца', count: 5, price: '500.00'}, где
    // id - идентификатор
    // title - наименование
    // price - цена
    // count - количество
